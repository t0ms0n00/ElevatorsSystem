...
public class ElevatorUpComparator implements Comparator<DoubleTuple> {
    @Override
    public int compare(DoubleTuple o1, DoubleTuple o2) {
        if(o1.getDirection() == 1 && o2.getDirection() == 1){ /// both requests up
        ...
        return 1;   /// both down, schedule doesn't matter for now
    }
}
